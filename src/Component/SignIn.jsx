...
const SignIn = () => {
  ...
  return (
    <>
      <section className='home-image2 px-5 lg:px-40 pt-5 pb-10'>
        <div>
          <img src={NetflixLogo} alt="Netflix Logo" className="w-26 md:w-32 lg:w-44 fill-red-600 mb-5" />
        </div>

        <div className='text-white mx-auto bg-gradient-to-t from-black/75 to-black/75 w-full lg:w-[45%] px-16 pt-10 rounded-md pb-20'>
